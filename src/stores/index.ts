import { Expert, GlobalState } from '@/types'
...
export const createGlobalExperState = () => {
  //만약, Singleton에 globalState가 없으면 다시 생성
  if( Singleton.globalState == null){
    const globalState: any = reactive({
      loginedExpert: {
      ...
      memberType: "",
      memberId: 0,
      isLogined: computed(() => globalState.loginedExpert.id != 0),
...
export const getGlobalExperState = createGlobalExperState;
