...
<ion-content :fullscreen="true">
  <ion-custom-body class="justify-center">
      ...
      <!--진행단계-->
        ...
        <div class="flex-col">
          <ion-item-divider class="mt-2">
            <ion-button color="" slot="end" :href="'/clientOrder/detail?id=' + order.id">
              상세보기
            </ion-button>
          </ion-item-divider>
          <ion-item-divider class="mt-2">
            <ion-button v-if="globalState.loginedClient.id == order.clientId" color="" slot="end" :href="'/clientOrder/detail?id=' + order.id">
    ...
    <div v-else class="ifEmptyOeders">
      ...
      <div class="px-4">
        <ion-button class="btn-primary" href="/clientOrder/add" color="" type="button" expand="block">
